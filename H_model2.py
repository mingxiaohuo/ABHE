...
def _conv_block(x, num_out_layers, kernel_sizes, strides):
    conv1 = slim.conv2d(x,num_outputs=num_out_layers[0], kernel_size=[3,3], activation_fn=tf.nn.relu)
    conv2 = slim.conv2d(conv1,num_outputs=num_out_layers[1], kernel_size=[3,3], activation_fn=tf.nn.relu)
    return conv2
...
def _H_model(input1, input2, is_training):
    ...
    with tf.compat.v1.variable_scope('Reggression_Net1'):    
      ...
      net1_conv1 = slim.conv2d(global_correlation,num_outputs=512, kernel_size=[3,3], activation_fn=tf.nn.relu)  
      net1_conv2 = slim.conv2d(net1_conv1,num_outputs=512, kernel_size=[3,3], activation_fn=tf.nn.relu) 
      net1_conv3 = slim.conv2d(net1_conv2,num_outputs=512, kernel_size=[3,3], activation_fn=tf.nn.relu)   
    ...
    with tf.compat.v1.variable_scope('Reggression_Net2'):    
      ...
      #3-convolution layers
      net2_conv1 = slim.conv2d(local_correlation_2,num_outputs=256, kernel_size=[3,3], activation_fn=tf.nn.relu)
      net2_conv2 = slim.conv2d(net2_conv1,num_outputs=256, kernel_size=[3,3], activation_fn=tf.nn.relu)
      net2_conv3 = slim.conv2d(net2_conv2,num_outputs=256, kernel_size=[3,3], stride=2,activation_fn=tf.nn.relu) 
      # Flatten dropout_conv4
    ...
    with tf.compat.v1.variable_scope('Reggression_Net3'):    
      ...
      #3-convolution layers
      net3_conv1 = slim.conv2d(local_correlation_3,num_outputs=128, kernel_size=[3,3], activation_fn=tf.nn.relu)
      net3_conv2 = slim.conv2d(net3_conv1,num_outputs=128, kernel_size=[3,3], stride=2,activation_fn=tf.nn.relu)
      net3_conv3 = slim.conv2d(net3_conv2,num_outputs=128, kernel_size=[3,3], stride=2,activation_fn=tf.nn.relu) 
      # Flatten dropout_conv4
